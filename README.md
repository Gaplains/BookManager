...
| 成员 | 分工 |
| --- | --- |
| 成员 A | 后端 Controller/Service/Mapper、数据库设计、接口调试 |
| 成员 B | Vue 页面、Element UI 美化、权限菜单、前后端联调 |
| 成员 C | AI 功能设计、README/需求文档/用户手册/PPT、测试与演示视频 |
...
| AI 编程工具 | Bug 排查 | 修复管理员代用户借阅表单字段绑定问题 | 确认用户选择框绑定 `userid`，避免借阅参数错误 |
